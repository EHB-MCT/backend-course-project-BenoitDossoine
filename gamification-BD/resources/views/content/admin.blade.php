...
@section('content')
    <div class="py-12 max-w-7xl mx-auto sm:px-6 lg:px-8">
        <h1 class="text-center uppercase text-6xl font-extralight">Admin panel</h1>
