                        ...
                        @foreach($quest->achievements as $achievement)
                            @if($achievement->status == 'pending')
                                <div class="userProgressContainer flex flex-row justify-between px-4">
                                    ...
                                    <div>
                                        <button class="border border-black rounded p-2 hover:border-green-500"
                                        ...
                                        document.getElementById('achievement{{$achievement->id}}Form').submit();">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 hover:fill-green-500" viewBox="0 0 20 20" fill="currentColor">
                                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                                            </svg>
                                        </button>
                                        <button class="border border-black rounded p-2 hover:border-red-800"
                                                onclick="event.preventDefault();
                                                    document.getElementById('achievement{{$achievement->id}}StatusInput').value='not completed';
                                                    document.getElementById('achievement{{$achievement->id}}Form').submit();">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 hover:fill-red-800" viewBox="0 0 20 20" fill="currentColor">
